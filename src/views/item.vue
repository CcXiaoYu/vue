				...
				<div class="gallery-wrapper">
					<div class="gallery">
						<div class="thumbnail">
							<ul>
								<li 
                                    v-for="imgs,index in itemInfo.ali_images" 
						...
						<div class="thumb">
							<ul>
								<li 
                                    ...
                                    :class="{'on':index===imgIndex}"
                                >
                                    <img :src="imgs + '?x-oss-process=image/resize,w_440/quality,Q_90/format,webp'">
                                </li>
							</ul>
						</div>
					</div>
						...
						<div class="sku-dynamic-params clear">
							...
							<ul class="params-colors">
								<li 
                                    ...
                                    :class="{'cur':colors.id == $route.query.itemId}"
                                >
                                    <router-link :to="{name: 'Item', query: {itemId:colors.id}}">
						...
						<div class="sku-dynamic-params clear">
							...
							<div class="params-detail clear">
								<div class="item-num js-select-quantity">
									<span :class="{'down-disabled': count <= 1}" class="down" @click="subCount()">-</span>
									<span class="num">{{count}}</span>
									<span :class="{'up-disabled': count >= itemInfo.limit_num}" class="up" @click="addCount()">+</span>
								</div>
							</div>
						</div>
					</div>
